...
namespace YourNamespace.Controller
{
    ...
    public class DocumentsController : ControllerBase
    {
        ...
        [HttpGet("ByPropertyAndTenant/{propertyId}/{tenantId}")]
        public ActionResult<Document> GetDocumentByPropertyAndTenant(string propertyId, string tenantId)
        {
            var document = _documentService.GetDocumentByPropertyAndTenant(propertyId, tenantId);
