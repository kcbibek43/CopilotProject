...
public class DocumentService
{
    ...
    public  List<Document> GetByTenantId(string id) =>
        _documents.Find<Document>(document => document.TenantId == id).ToList();
    ...
    public Document GetDocumentByPropertyAndTenant(string propertyId, string tenantId) =>
        _documents.Find<Document>(document => document.PropertyId == propertyId && document.TenantId == tenantId).FirstOrDefault();
